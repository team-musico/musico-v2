...
const ChartScreen = ({ tracks }: { tracks: VibeTrack[] }) => {
  const {
    playVibeTrack,
    loadingTrackId,
  } = useMusicPlayer();

  return <TrackTable title="Korea Top 100" tracks={tracks} onPlay={playVibeTrack} loadingTrackId={loadingTrackId} emptyText="표시할 음원 목록이 없습니다." />;
};
